...
function buscar_usuario($this) {
    ...
    $("#buscar-usuario").load("frm/crm/definiciones/usuarios/buscarUsuarios.html", function () {
...
function seleccionar_usuario($this) {
    ...
    buscar_id_usuario_ajax(id_usuario);
}

function buscar_id_usuario_ajax(id_usuario) {
    var pDatosFormulario = "&id_usuario=" + id_usuario;
    var pUrl = 'usuario/buscarId';
    var pBeforeSend = '';
