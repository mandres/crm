 ...
 */
@WebServlet(name = "PermisoBuscarId", urlPatterns = {"/permiso/buscarId"})
public class PermisoBuscarId extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Permiso permiso = permisoDAO.buscarId(id_permiso);
