 ...
 */
@WebServlet(name = "ProductoAgregar", urlPatterns = {"/producto/agregar"})
public class ProductoAgregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int id_temporada = Integer.parseInt(request.getParameter("id_temporada"));
           ...
           Producto producto = new Producto();
            ...
            Map agregado = productoDAO.agregar(producto);

            JSONObject obj = new JSONObject();
            obj.put("agregado", agregado.get("ok"));
            obj.put("id_producto", agregado.get("id_producto"));
